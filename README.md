...
### 核心功能
- 🔗 **情侣绑定**：通过识别码快速绑定伙伴账号
- 📋 **菜单管理**：自定义菜品分类和菜品信息，支持图片上传
- 🛒 **智能点单**：一方点单，另一方接单制作
- ✅ **订单管理**：订单状态跟踪、完成确认、用餐评价
- 📅 **餐饮日记**：日历视图记录每次用餐，博客风格展示
- 🎮 **互动游戏**：疯狂点点点游戏，增进情侣互动
...
| `dishes` | name, desc, image, categoryId, sort | 菜品信息 |
| `orders` | dishes[], note, status, creatorName, creatorAvatar, partnerId, createdAt, doneAt | 订单记录 |
